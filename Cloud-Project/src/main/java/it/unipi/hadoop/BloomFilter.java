        ...
        public void reduce(Text key, Iterable<Filter> values, Context context) throws IOException, InterruptedException {
            ...
            if(key.toString().compareTo("1.0")==0){
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n1.0")), 0.01, 1.0);
                    f1.or(value.bitArray, Integer.parseInt(conf.get("m1.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n2.0")), 0.01, 2.0);
                    f2.or(value.bitArray, Integer.parseInt(conf.get("m2.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n3.0")), 0.01, 3.0);
                    f3.or(value.bitArray, Integer.parseInt(conf.get("m3.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n4.0")), 0.01, 4.0);
                    f4.or(value.bitArray, Integer.parseInt(conf.get("m4.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n5.0")), 0.01, 5.0);
                    f5.or(value.bitArray, Integer.parseInt(conf.get("m5.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n6.0")), 0.01, 6.0);
                    f6.or(value.bitArray, Integer.parseInt(conf.get("m6.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n7.0")), 0.01, 7.0);
                    f7.or(value.bitArray, Integer.parseInt(conf.get("m7.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n8.0")), 0.01, 8.0);
                    f8.or(value.bitArray, Integer.parseInt(conf.get("m8.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m,Integer.parseInt(conf.get("n9.0")), 0.01, 9.0);
                    f9.or(value.bitArray, Integer.parseInt(conf.get("m9.0")));
                ...
                while(values.iterator().hasNext()){
                    Filter value = new Filter(values.iterator().next().m, Integer.parseInt(conf.get("n10.0")), 0.01, 10.0);
                    f10.or(value.bitArray, Integer.parseInt(conf.get("m10.0")));
